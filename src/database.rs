...
impl Database {
    ...
    pub fn append(&mut self, key: &str, value: &str) -> Result<String, DataBaseError> {
    ...
    pub fn set(&mut self, key: &str, val: &str) -> Result<String, DataBaseError> {
        self.dictionary
            .insert(String::from(key), StorageValue::String(val.to_string()));
        Ok(String::from("OK"))
    }

    pub fn decrby(&mut self, key: &str, number_of_decr: &str) -> Result<String, DataBaseError> {
        if let Some(StorageValue::String(val)) = self.dictionary.get_mut(key) {
    ...
    pub fn incrby(&mut self, key: &str, number_of_incr: &str) -> Result<String, DataBaseError> {
    ...
    pub fn getset(&mut self, key: &str, _new_val: &str) -> Result<String, DataBaseError> {
